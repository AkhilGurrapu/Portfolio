...
List<ProjectUtils> projectUtils = [
    ...
    description:
        'Developed, Chatting with New Open Large Language Models. This application offers a comparative analysis of some of the most sophisticated AI language models available. 🤖 Featuring top-tier models: - Snowflake-Arctic - Meta-Llama3-70B - Meta-Llama3-8B - Mistral-8x22B - Google-CodeGemma-7B - Google-Gemma-7B',
